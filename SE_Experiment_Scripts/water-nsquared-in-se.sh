...
build/$1/gem5.opt --outdir=water_nsquared-se-$1 configs/example/se.py --num-cpus=64 --num-dirs=64 --network=garnet2.0 --topology=Mesh_XY --mesh-rows=8 --cpu-type TimingSimpleCPU --ruby --cmd="$P_PATH/ext/splash2x/apps/water_nsquared/inst/amd64-linux.gcc/bin/water_nsquared" --options="64" < $SIMSMALL 
