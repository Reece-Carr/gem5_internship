...
# 8x8
build/$1/gem5.opt configs/example/se.py --num-cpus=64 --num-dirs=64 --network=simple --topology=Mesh_XY --mesh-rows=8 --cpu-type TimingSimpleCPU --ruby --cmd="$PATH/pkgs/apps/ferret/inst/amd64-linux.gcc/bin/ferret" --options="$SIMSMALL 64 $PATH/pkgs/apps/ferret/run/output.txt"
